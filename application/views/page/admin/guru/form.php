...
<section class="section">
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title text-center mb-3">Form Guru</h5>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="nuptk" value="<?= get_form_value($form, 'nuptk') ?>" class="form-control">
                        </div>
                    </div>
                    <div class="row mb-3">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <select class="form-select" name="id_jabatan" aria-label="Default select example" required>
                                ...
                                <?php foreach ($jabatan as $isi) : ?>
                                    <option value="<?= $isi->id ?>" <?= get_form_value($form, 'id_jabatan') == $isi->id ? 'selected' : '' ?>><?= $isi->nama ?></option>
                                <?php endforeach; ?>
                            </select>
                        </div>
                    </div>
